<footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="https://hohtechlabs.com">HOH Tech Labs Pvt Ltd</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- DataTables -->
<script src="<?php echo $dir; ?>/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="<?php echo $dir; ?>/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
<script src="<?php echo $dir; ?>/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- ChartJS -->
<script src="<?php echo $dir; ?>/bower_components/chart.js/Chart.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo $dir; ?>/dist/js/pages/dashboard2.js"></script>
