  ...
  if($_POST){
    ...
    if(isset($_FILES["image"]["name"]) && !empty($_FILES["image"]["name"]))
    {
      ...
      if(move_uploaded_file($file_tmp,$physical_dir.$image))
      {
        ...
        $sql         = "UPDATE events SET name='$name',date='$date__',time='$time',venue='$venue',description='$description',image='$image',updated_at='$date' WHERE id=".base64_decode($_GET['id']);
      ...
      $description = str_replace("'", "", $_POST['description']);
      $date        = date('Y-m-d h:i:s');
      $sql         = "UPDATE events SET name='$name',date='$date__',time='$time',venue='$venue',description='$description',updated_at='$date' WHERE id=".base64_decode($_GET['id']);
