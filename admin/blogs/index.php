            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
					...
					$sql = "SELECT * FROM blogs WHERE is_deleted=1";
                ...
                <tr>
                  <td><?php echo $id++; ?></td>
                  <td><img style="height: 50px;width: 100px;" src="../<?php echo $row["image"]; ?>" > </td>
                  ...
                  <td>
                  	...
                  	<a href="./view.php?id=<?php echo base64_encode($row["id"]); ?>"><i class="fa fa-code"></i></a>&nbsp;
