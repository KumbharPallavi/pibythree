  ...
  if($_POST){
    ...
    if(isset($_FILES["image"]["name"]) && !empty($_FILES["image"]["name"]))
    {
      ...
      if(move_uploaded_file($file_tmp,$physical_dir.$image))
      {
        ...
        $sql       = "INSERT INTO blogs (slug,title,category,tag,publish,created_at,meta,image,shot_description,description,updated_at) VALUES ('$slug','$title','$category','$tag','$publish','$created_at','$meta','$image','$shot_description','$description','$date')";
            ...
            <form role="form" action="./add.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-3">
                  <div class="box-body">
                    <div class="form-group">
                      <img id="output_image1" height="150px" width="100%" src="./../dist/img/sample.jpg" />
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="shot_description"></textarea>
                    </div>
                  </div>
                </div>
              </div>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="editor" rows="6" name="description"></textarea>
                </div>
              </div>
              <!-- /.box-body -->
