<?php 
  ...
  if($_POST){
    ...
    if(isset($_FILES["image"]["name"]) && !empty($_FILES["image"]["name"]))
    {
      ...
      $image                   = 'uploads/success_stories/'.$random_file_name;
      if(move_uploaded_file($file_tmp,$physical_dir.$image))
      {
        ...
        $sql         = "UPDATE success_stories SET name='$name',short_description='$short_description',description='$description',image='$image',updated_at='$date' WHERE id=".base64_encode($_GET['id']);
      ...
      $short_description = str_replace("'", "", $_POST['short_description']);
      $date        = date('Y-m-d h:i:s');
      $sql         = "UPDATE success_stories SET name='$name',description='$description',short_description='$short_description',updated_at='$date' WHERE id=".base64_decode($_GET['id']);
      if ($conn->query($sql) === TRUE) {
  ...
  $sql       = "SELECT * FROM success_stories WHERE id=".base64_decode($_GET['id'])." limit 1";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"><i class="fa fa-dashboard"></i> Success Stories</a></li>
        <li class="active">Edit Success Stories</li>
      </ol>
    </section>
            ...
            <form role="form" action="./edit.php?id=<?php echo base64_encode($id); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="short_description"><?php echo $short_description; ?></textarea>
                </div>
              </div>
              <div class="box-body">
                <div class="form-group">
