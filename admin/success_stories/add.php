  ...
  if($_POST){
    ...
    if(isset($_FILES["image"]["name"]) && !empty($_FILES["image"]["name"]))
    {
      ...
      if(move_uploaded_file($file_tmp,$physical_dir.$image))
      {
        ...
        $sql       = "INSERT INTO success_stories (name,description,short_description,image,created_at) VALUES ('$name','$description','$short_description','$image','$date')";
        // print_r( $sql);die;
...
#output_image1{ object-fit:contain; }
</style>
            ...
            <form role="form" action="./add.php" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <img id="output_image1" height="300px" width="100%" src="./../dist/img/success-stories-banner.jpg" />
