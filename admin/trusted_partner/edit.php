<?php 
  ...
  if($_POST){
    ...
    if(isset($_FILES["image"]["name"]) && !empty($_FILES["image"]["name"]))
    {
      ...
      $image                   = 'uploads/trusted_partner/'.$random_file_name;
      if(move_uploaded_file($file_tmp,$physical_dir.$image))
      {
        ...
        $sql       = "UPDATE trusted_partner SET name='$name',image='$image',updated_at='$date' WHERE id=".base64_decode($_GET['id']);
      ...
      $name      = $_POST['name'];
      $date      = date('Y-m-d h:i:s');
      $sql       = "UPDATE trusted_partner SET name='$name',updated_at='$date' WHERE id=".base64_decode($_GET['id']);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Trusted Partner</li>
      </ol>
    </section>
