<?php 
  ...
  if($_POST){
    ...
    if(isset($_FILES["image"]["name"]) && !empty($_FILES["image"]["name"]))
    {
      ...
      $image                   = 'uploads/solutions/'.$random_file_name;
      if(move_uploaded_file($file_tmp,$physical_dir.$image))
      {
        ...
        $sql         = "UPDATE solutions SET name='$name',description='$description',image='$image',updated_at='$date' WHERE id=".base64_decode($_GET['id']);

        if ($conn->query($sql) === TRUE) {
          $_SESSION['success'] = 'Record added successfully.';
          echo "<script>location.href = '".$dir."/solutions';</script>";
        } else {
      ...
      $description = str_replace("'", "", $_POST['description']);
      $date        = date('Y-m-d h:i:s');
      $sql         = "UPDATE solutions SET name='$name',description='$description',updated_at='$date' WHERE id=".base64_decode($_GET['id']);
  ...
  $sql       = "SELECT * FROM solutions WHERE id=".base64_decode($_GET['id'])." limit 1";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"><i class="fa fa-dashboard"></i> Solutions</a></li>
        <li class="active">Edit Solutions</li>
      </ol>
    </section>
